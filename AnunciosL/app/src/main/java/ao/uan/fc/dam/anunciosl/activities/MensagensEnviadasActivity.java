...
public class MensagensEnviadasActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.t8_mensagens_enviadas_activity);
        ...
        if (utilizador != null) {
            new BuscarMensagensEnviadasTask().execute(utilizador.getId());
        } else {
    ...
    private class BuscarMensagensEnviadasTask extends AsyncTask<String, Void, List<Anuncio>> {
        ...
        protected List<Anuncio> doInBackground(String... params) {
            ...
            try {
                ...
                String METHOD_NAME = "ListarMensagensEnviadas";
                ...
                for (int i = 0; i < response.getPropertyCount(); i++) {
                    ...
                    // Adicione mais propriedades conforme a tua classe
