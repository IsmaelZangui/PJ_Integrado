				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
								...
								<div class="m-sm-3">
									<form>
										<div class="text-center mt-4 p">
											...
											<img src="img/logo/logo.png" alt="Logo AnunciosLoc"
												class="img-fluid rounded-circle imagem-bottom"  width="200" height="128" />
						...
						<div class="text-center mb-3">
							Não tens um Conta? <a href="pages-sign-up.html">Criar uma</a>
						</div>
					</div>
				</div>
			</div>
